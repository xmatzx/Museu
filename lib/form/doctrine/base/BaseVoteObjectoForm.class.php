...
/**
 * VoteObjecto form base class.
 *
 * @method VoteObjecto getObject() Returns the current form's model object
 *
 * @package    museu
 * @subpackage form
 ...
 */
abstract class BaseVoteObjectoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vote_objecto[%s]');
