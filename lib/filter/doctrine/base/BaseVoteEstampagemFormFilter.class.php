...
/**
 * VoteEstampagem filter form base class.
 *
 * @package    museu
 * @subpackage filter
 ...
 */
abstract class BaseVoteEstampagemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vote_estampagem_filters[%s]');
