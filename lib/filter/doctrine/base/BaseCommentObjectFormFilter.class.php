...
/**
 * CommentObject filter form base class.
 *
 * @package    museu
 * @subpackage filter
 ...
 */
abstract class BaseCommentObjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comment_object_filters[%s]');
