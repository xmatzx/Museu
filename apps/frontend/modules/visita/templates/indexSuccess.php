          ...
          <div class='container-fluid'>
            ...
            <div class='nav-collapse'>
              <ul class='nav'>
                ...
                <li id='SalaCivil'><a href="<?php echo url_for('visita/index') ?>">Sala de Civil</a></li>
                <li id='SalaQuimica'><a href="<?php echo url_for('visita/index') ?>">Sala de Quimica</a></li>
                <li id='SalaMecanica'><a href="<?php echo url_for('visita/index') ?>">Sala de Mecânica</a></li>
                <li id='SalaFisica'><a href="<?php echo url_for('visita/index') ?>">Sala de Física</a></li>
              </ul>
            </div><!--/.nav-collapse -->
          </div>
        </div>
