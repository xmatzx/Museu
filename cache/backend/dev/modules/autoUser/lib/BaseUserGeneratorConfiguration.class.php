...
abstract class BaseUserGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%first_name%% - %%last_name%% - %%username%% - %%email_address%%';
  }
  ...
  {
    return 'Editando o Utilizador "%%username%%"';
  }
  ...
  {
    return array(  0 => 'first_name',  1 => 'last_name',  2 => 'username',  3 => 'email_address',);
  }
  ...
  public function getFieldsList()
  {
    return array(
      'id' => array(),
      'first_name' => array(  'label' => 'Primeiro Nome',),
      'last_name' => array(  'label' => 'Apelido',),
      'email_address' => array(  'label' => 'Email',),
      'username' => array(),
      'algorithm' => array(),
      'salt' => array(),
      'password' => array(),
